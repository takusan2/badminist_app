...
String parameterToString(dynamic value) {
  ...
  if (value is PlayerGender) {
    return PlayerGenderTypeTransformer().encode(value).toString();
  }
  if (value is PlayerLevel) {
    return PlayerLevelTypeTransformer().encode(value).toString();
  }
  if (value is PlayerStatus) {
    return PlayerStatusTypeTransformer().encode(value).toString();
  }
  if (value is Role) {
    return RoleTypeTransformer().encode(value).toString();
  }
  if (value is Rule) {
    return RuleTypeTransformer().encode(value).toString();
  }
