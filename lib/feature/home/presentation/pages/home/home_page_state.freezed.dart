...
class _$_HomePageState extends _HomePageState {
  _$_HomePageState({this.selectedCommunity}) : super._();
  ...
  @override
  String toString() {
    return 'HomePageState(selectedCommunity: $selectedCommunity)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, selectedCommunity);
...
abstract class _HomePageState extends HomePageState {
  factory _HomePageState({final String? selectedCommunity}) = _$_HomePageState;
  _HomePageState._() : super._();

  @override
  String? get selectedCommunity;
  @override
  @JsonKey(ignore: true)
  _$$_HomePageStateCopyWith<_$_HomePageState> get copyWith =>
      throw _privateConstructorUsedError;
